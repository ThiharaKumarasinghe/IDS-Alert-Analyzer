...
import json
from mining_functions import adaptive_bin_handling, return_unique_labels, get_field_and_value, map_ranges_to_pattern_df
...
def mining_patterns_CHARM(alert_file_path):
    ...
    mapped_patterns = mapped_patterns.fillna("NaN")


     # Create the JSON-friendly pattern data
    mapped_patterns_data = mapped_patterns.to_dict(orient='records')

    # Return both the pattern count and the data
    return pattern_count, mapped_patterns_data
